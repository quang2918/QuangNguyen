...
namespace quanlybanhang.Models
{
    class chitiethdM
    {
        ...
        public DataTable Getdata(string ma)
        {
            ...
            cmd.CommandText = " select ct.mahoadon, hh.tenhang, hh.dongia, ct.soluongban from dbo.chitiethoadon ct, dbo.hanghoa hh where ct.mahanghoa = hh.mahang and mahoadon= '"+ma+"'";
